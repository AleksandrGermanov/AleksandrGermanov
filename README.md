...
Планирую погрузиться с головой в мир Java-разработки и приобрести экпертные знания в одной из ее областей.
...
Сервис для объявления и посещения мероприятий (дипломный проект).
...
Сервис сдачи вещей в аренду (scrum).
